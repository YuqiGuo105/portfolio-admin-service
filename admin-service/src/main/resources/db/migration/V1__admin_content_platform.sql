-- V1: Admin content platform tables (versioning, outbox, indexing, audit)
-- Existing tables (public."Blogs", public."Projects", public.life_blogs,
-- public.experience, public.kb_documents) remain the source of truth.
...
CREATE TABLE IF NOT EXISTS public.content_event_outbox (
    ...
    -- CONTENT_CREATED | CONTENT_UPDATED | CONTENT_PUBLISHED | CONTENT_ARCHIVED | CONTENT_DELETED
    ...
    topic           text NOT NULL,
    -- ARTICLE_UPDATES | FEATURE_UPDATES | JOB_UPDATES
...
CREATE TABLE IF NOT EXISTS public.content_admin_audit_logs (
    ...
    -- CREATE | UPDATE | PUBLISH | ARCHIVE | DELETE | REINDEX_RAG | REINDEX_SEARCH | RETRY_INDEXING_JOB
